  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/assets/gallery/img13.jpeg')",
        }}
      />
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-20 bg-[#07111f]/35"
      />

      {/* Left-side readability */}
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-20 bg-gradient-to-r from-[#07111f]/95 via-[#07111f]/72 to-[#07111f]/30"
      />

      {/* Bottom fade */}
      <div
        aria-hidden="true"
        className="absolute inset-x-0 bottom-0 -z-20 h-72 bg-gradient-to-t from-[#07111f] via-[#07111f]/80 to-transparent"
      />

      {/* Top fade */}
      <div
        aria-hidden="true"
        className="absolute inset-x-0 top-0 -z-20 h-40 bg-gradient-to-b from-[#07111f]/65 to-transparent"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-24 sm:px-8 sm:py-28 lg:px-12 lg:py-36">
        ...
        <div className="relative mt-14 overflow-hidden rounded-[2rem] border border-white/15 bg-[#07111f]/70 shadow-2xl shadow-black/30 backdrop-blur-md sm:mt-16 lg:mt-20">
          {/* Panel glow */}
          <div
            aria-hidden="true"
            className="absolute -right-32 -top-32 h-80 w-80 rounded-full bg-amber-300/[0.06] blur-[100px]"
          />
          ...
          <div className="relative grid lg:grid-cols-12">
            ...
            <div className="border-t border-white/10 p-7 sm:p-10 lg:col-span-6 lg:border-t-0 lg:p-12 xl:p-14">
              <div className="space-y-7">
                {aboutData.story.paragraphs.slice(1).map((paragraph, index) => (
                  <p
      ...
      >
        <div
          className="absolute inset-x-0 bottom-[-1px] h-16 bg-white"
          style={{
            clipPath:
              "polygon(0 58%, 11% 28%, 23% 68%, 37% 25%, 51% 60%, 66% 30%, 82% 55%, 100% 12%, 100% 100%, 0 100%)",
          }}
        />
      </div>
    </section>
