...
export default function ProjectGallery() {
  ...
  const showPrevious = () => {
    if (selectedImage === null || totalImages === 0) return;
  ...
  return (
    <>
      ...
      >
          ...
          >
            ...
            <div className="mb-8 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="h-px w-10 bg-[#b58950] sm:w-14" />
            ...
            {/* Heading */}
            <h2 className="max-w-5xl text-[3.25rem] font-medium leading-[0.88] tracking-[-0.07em] sm:text-6xl md:text-7xl lg:text-[6.4rem]">
              Spaces we have
              <br />
            ...
            <div className="mt-9 flex flex-col gap-7 border-b border-[#17201d]/10 pb-8 sm:flex-row sm:items-end sm:justify-between">
              ...
              <div className="flex shrink-0 items-center gap-4">
                <span className="h-px w-8 bg-[#b58950]" />
        ...
        <div className="pointer-events-none absolute left-5 top-5 h-8 w-8 border-l border-t border-[#17201d]/15 sm:left-8 sm:top-8" />

        <div className="pointer-events-none absolute bottom-5 right-5 h-8 w-8 border-b border-r border-[#17201d]/15 sm:bottom-8 sm:right-8" />
      </section>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="group absolute right-3 top-1/2 z-30 flex h-11 w-11 -translate-y-1/2 -translate-y-1/2 items-center justify-center border border-white/15 bg-black/20 text-lg text-white/60 backdrop-blur-md transition-all duration-300 hover:border-[#f0c982] hover:bg-[#f0c982] hover:text-[#101715] sm:right-7 sm:h-12 sm:w-12"
      >
        <span className="transition-transform duration-300 group-hover:translate-x-0.5">
          →
        </span>
